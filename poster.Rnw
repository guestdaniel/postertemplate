...
\PassOptionsToPackage{rgb}{xcolor} % switch rgb -> cmyk and proof before printing
...
\begin{figure}
<<iris_example_1, cache=TRUE, fig.width=10, fig.asp=0.3, out.width="\\linewidth", echo=FALSE>>=
plot1 = ggplot(iris, aes(x=Sepal.Length, y=Sepal.Width, color=Petal.Length)) + geom_point() + facet_wrap(~Species)
plot1 = plot1 + xlab("Sepal Length") + ylab("Sepal Width") + scale_color_continuous(name="Petal Length")
plot1
@
...
\begin{figure}
<<iris_example_2, cache=TRUE, echo=FALSE, fig.width=10, fig.asp=0.3, out.width="\\linewidth">>=
plot2 = ggplot(iris, aes(x=Petal.Width, fill=Species)) + geom_density()
plot2 = plot2 + xlab("Petal Width") + ylab("Density")
plot2
@
...
\begin{figure}
<<diamonds_example_1, cache=TRUE, echo=FALSE, fig.width=10, fig.asp=0.3, out.width="\\linewidth">>=
plot3 = ggplot(diamonds, aes(x=carat, y=price, color=color)) + geom_point()
plot3 = plot3 + xlab("Carat") + ylab("Price ($)") + scale_color_discrete(name="Color")
plot3
@
