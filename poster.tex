		...
		\begin{column}{\onecolwid} % Column 1 <Begin>
				...
				\begin{block}{How it works}
						\begin{itemize}
							\item The files
								\begin{itemize}
									\item beamerthemconfposter.sty --- contains definitions of the title and blocks, as well as colors and theme options
									\item beamerposter.sty --- provides the beamerposter package
									\item poster.Rnw --- the source file, which is turned into a .tex file by KnitR
								\end{itemize}
							...
							\item R code is delimited by special characters <<>> and @
								\end{itemize}
						\end{itemize}
				\end{block}
